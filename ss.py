...
def f(t, y, D_omeg, d_omeg, K, theta, p, T, tau):
    ...
    # Ensure consistent dimensions with np.atleast_1d
    E1 = np.atleast_1d(E1)  # Convert E1 to at least 1 dimension
...
# Define time array
t = np.linspace(0, 20, 1000)  # Define time array explicitly
...
for i, d_omeg in enumerate(d_omeg_range):
    for j, theta in enumerate(theta_range):
        ...
        solution = RK4(f, y0, t, D_omeg, d_omeg
